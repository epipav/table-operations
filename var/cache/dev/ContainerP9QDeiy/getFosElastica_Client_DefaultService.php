...
class getFosElastica_Client_DefaultService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['fos_elastica.client.default'] = $instance = new \FOS\ElasticaBundle\Elastica\Client(['connections' => [0 => ['host' => 'elasticsearch', 'port' => 9200, 'http_error_codes' => [0 => 400, 1 => 403, 2 => 404], 'ssl' => false, 'logger' => 'fos_elastica.logger', 'compression' => false, 'headers' => [], 'curl' => [], 'retryOnConflict' => 0, 'persistent' => true]], 'connectionStrategy' => 'Simple'], NULL);
