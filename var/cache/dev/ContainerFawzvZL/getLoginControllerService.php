...
class getLoginControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.Ozxxzzj'] ?? $container->load('get_ServiceLocator_OzxxzzjService'))->withContext('App\\Controller\\LoginController', $container));
